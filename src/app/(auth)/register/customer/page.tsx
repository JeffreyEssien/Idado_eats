...
export default function CustomerRegisterPage() {
  ...
  return (
    <div className="min-h-screen grid sm:grid-cols-2">
      {/* Left — brand panel */}
      <div className="hidden sm:flex flex-col justify-between bg-gradient-to-br from-orange-500 to-amber-600 text-white p-10 relative overflow-hidden">
        ...
        <div className="relative">
          ...
          <h2 className="mt-6 text-4xl font-extrabold leading-tight">Order anything<br />in the estate.</h2>
          <p className="mt-3 text-white/70 text-sm max-w-xs">Restaurants, marts, pharmacies — all delivered to your door in minutes.</p>
        </div>
      ...
      <div className="flex items-center justify-center px-6 py-12">
        <div className="w-full max-w-sm">
          ...
          <h1 className="mt-4 text-2xl font-extrabold tracking-tight">Create Customer Account</h1>
          <p className="mt-1 text-sm text-muted-foreground">Start ordering from estate stores</p>
          ...
          <form onSubmit={handleSubmit} className="mt-8 flex flex-col gap-4">
            ...
            <Input label="Delivery Address (within estate)" id="address" placeholder="12 Palm Avenue, Idado Estate" value={form.address} onChange={(e) => update('address', e.target.value)} required />
